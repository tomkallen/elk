...
var Helm = function (_mix$with) {
    ...
    function Helm(selector) {
        ...
        if (Helm._isTag(selector)) {
            _this.el = Helm._createNewElement(selector);
        } else {
            _this.el = Array.from(document.querySelectorAll(selector));
        }
        return _this;
    }
    ...
    _createClass(Helm, [{
        ...
        value: function _createNewElement(selector) {
            var tag = selector.slice(1, selector.length - 1);
        ...
        key: '_isTag',
        value: function _isTag(selector) {
    ...
    return Helm;
}((0, _mixer.mix)(Helm__PROTO).with(_modules.attributes, _modules.css, _modules.manipulation, _modules.visibility));
...
exports.visibility = exports.manipulation = exports.css = exports.attributes = undefined;
...
exports.attributes = _attributes.attributes;
    ...
    return function (_superclass) {
        ...
        _createClass(_class, [{
            ...
            value: function hasClass(cl, el) {
                ...
                return cl ? h(this._getNodeList(el).filter(function (e) {
                    return e.classList.contains(cl);
                })) : h(this._getNodeList(el).filter(function (e) {
                    return e.className;
                }));
            }
        }, {
        ...
        _createClass(_class, [{
            ...
            value: function before(elA, elB) {
                ...
                target.forEach(function (e) {
                    return e.parentNode.insertBefore(el, e);
                });
            ...
            value: function after(elA, elB) {
                ...
                target.forEach(function (e) {
                    return e.parentNode.insertBefore(el, e.nextSibling);
                });
...
var attributes = exports.attributes = function attributes(superclass) {
    return function (_superclass) {
        _inherits(_class, _superclass);
        ...
        _createClass(_class, [{
            key: "attr",
            value: function attr(arg, el) {
                if (typeof arg === "string") {
                    var filteredElements = this._getNodeList(el).filter(function (e) {
                        return e.getAttribute(arg);
                    });
                ...
                if ((typeof arg === "undefined" ? "undefined" : _typeof(arg)) === "object") {
                    this._getNodeList(el).forEach(function (el) {
                        Object.keys(arg).forEach(function (attr) {
                            if (!arg[attr]) {
